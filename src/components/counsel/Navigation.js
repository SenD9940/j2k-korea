...
function Navigation({selectedNav, onNavClickHandler}){
    return(
        <Container>
            <Item id="common" onClick={onNavClickHandler} isclicked={selectedNav === "common" ? "true" : "false"}>
                <ItemTitle>AI 상담원 연결</ItemTitle>
                <ItemContent>제품 개발/생산/유통/마케팅 전반 문의 사항에 대해서 빠르게 답변 드립니다</ItemContent>
            </Item>
            <Item id="service" onClick={onNavClickHandler} isclicked={selectedNav === "service" ? "true" : "false"}>
